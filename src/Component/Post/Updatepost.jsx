...
<Styledformcontrol>
    ...
    <StledInputbase placeholder="Title" value={postdata.title} autoFocus color="primary"  name="title" onChange={(e)=>contentChange(e)}/>
    <StyledButton onClick={updatePost}>Publish</StyledButton>
    
</Styledformcontrol>
<StyledTextare minRows={5} placeholder='write content' value={postdata.description}  title="description" name="description" onChange={(e)=>contentChange(e)}/>
    </Container>
  )
}
